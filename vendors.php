                ...
                <div class="yafuso_vendors_hero_029">
                    ...
                    <div class="yafuso_single_029">
                        <div class="yafuso_vendors_hero_inner_029">
                            ...
                            <h2>出店をご検討の方へ</h2>
                            <p class="yafuso_vendors_copy_029">出店したい意欲を、<br>この場所から形に。</p>
                            <p class="yafuso_vendors_intro_029">初期費用を抑えながら、お店のファンを最短で<br>
                                育てられる環境が、屋富祖のこの場所にはあります。</p>
                            <ul class="yafuso_vendors_hero_points_029" aria-label="出店しやすいポイント">
                                <li><i class="fa-solid fa-yen-sign" aria-hidden="true"></i>初期費用少なめ</li>
                                <li><i class="fa-solid fa-seedling" aria-hidden="true"></i>スタートアップにも◎</li>
                                <li><i class="fa-solid fa-route" aria-hidden="true"></i>58号線沿い・好立地</li>
                                <li><i class="fa-solid fa-square-parking" aria-hidden="true"></i>駐車場100台完備</li>
                            </ul>
                            <div class="yafuso_vendors_hero_actions_029">
                                <a href="#vendors_rooms"><i class="fa-solid fa-store" aria-hidden="true"></i>今すぐ物件をチェック</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="yafuso_vendors_message_grid_029">
                            <div class="yafuso_vendors_message_text_029">
                                ...
                                <p class="tcenter">お店同士がお客様を共有し、ともに成長していくのが”やふそ屋台村 ちょうちん横丁”の特徴です。<br>
                                    ...
                                    同じ志を持つ仲間が今日もちょうちん横丁で、あかりを灯しています。</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="yafuso_vendors_merit_029">
                    <div class="yafuso_single_029">
                        <div class="yafuso_vendors_title_029">
                            ...
                            <h2>出店のメリット</h2>
                            <p>開業前の不安を減らし、お店のファンを育てるための環境が整っています。</p>
                        </div>
                ...
                <div id="vendors_rooms" class="yafuso_vendors_rooms_029">
                    <div class="yafuso_single_029">
                        <div class="yafuso_vendors_title_029">
                            <span aria-hidden="true"></span>
                            <h2>物件のご案内</h2>
                            <p>やふそ屋台村 ちょうちん横丁がある<br>
                                丸真本社ビル内の現在募集中の物件をご紹介します。</p>
                        </div>
                            ...
                            <div class="yafuso_vendor_room_body_029">
                                ...
                                <div class="yafuso_vendor_room_info_029">
                                    <dl>
                                        ...
                                        <div>
                                            <dt>備考</dt>
                                            <dd>家賃・共益費は消費税込み。毎月別途光熱費あり。店主様・従業員の方向け駐車場1〜2台無料</dd>
                                        </div>
                                    </dl>
                                    ...
                                    <a href="#vendors_contact_form" class="yafuso_vendor_room_apply_029">お申込み・お問い合わせはこちら</a>
                                </div>
                            </div>
                        </article>
                ...
                <div class="yafuso_vendors_rules_029">
                    <div class="yafuso_single_029">
                        ...
                        <div class="yafuso_vendors_rule_grid_029">
                            ...
                            <article>
                                <h3>光熱費</h3>
                                <p>お客様専用スペースの空調設備に関わる光熱費は、自店舗分とは別途算出となります。</p>
                            </article>
                            <article>
                                <h3>共用部の清潔維持</h3>
                                <p>通路・トイレ・ゴミ置き場などの共用スペースは、出店者全員で協力して清潔に保っていただいております。</p>
                            </article>
                            <article>
                                <h3>騒音・近隣への配慮</h3>
